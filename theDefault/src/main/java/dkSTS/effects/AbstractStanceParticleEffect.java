...
public abstract class AbstractStanceParticleEffect extends AbstractGameEffect {
    ...
    public AbstractStanceParticleEffect(Color color, TextureAtlas.AtlasRegion img) {
        this.img = img;

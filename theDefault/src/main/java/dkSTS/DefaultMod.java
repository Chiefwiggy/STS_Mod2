...
import dkSTS.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String ATTACK_DEFAULT_GRAY = "dkSTSResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "dkSTSResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "dkSTSResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "dkSTSResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "dkSTSResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "dkSTSResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "dkSTSResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "dkSTSResources/images/1024/bg_power_default_gray.png";
...
//            BaseMod.addPotion(ChillPotion.class, ChillPotion.data.LIQUID_COLOR, ChillPotion.data.HYBRID_COLOR, ChillPotion.data.SPOTS_COLOR, ChillPotion.data.ID, TheBruxa.Enums.THE_BRUXA);
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("dkSTS") // ${project.artifactId}
